<?php
/**
 * Formulaire nouvel acces ouvrage
 */
?>
<?php ob_start(); ?>
        ...
        <p>
            ...
            <select class=form-control name="user" id="user">
                ...
                <?php while ($userList = $users->fetch()) : ?>
                    <option value="<?= $userList['USER_ID'] ?>"><?= $userList['USER_PSEUDO'] ?></option>';
                <?php endwhile; ?>
                ?>
            </select>  <br />
            ...
            <select class=form-control name="statut" id="statut">
                ...
                <?php while ($statutList = $statuts->fetch()) : ?>
                    <option value="<?= $statutList['p5_STATUT_ID'] ?>"><?= $statutList['STATUT'] ?></option>
                <?php endwhile; ?>
